 ...
 */
contract TipsyERC721Marketplace is Ownable, Pausable, ReentrancyGuard {
    ...
    function sell (
        ...
        uint256 tokenId,
        uint256 price
    ) public whenNotPaused() onlyWhitelisted(nftContract) nonReentrant() {
     ...
     * @param tokenId token identifier.
     */
    function cancelListing(address nftContract, uint256 tokenId) public whenNotPaused() {
       IERC721 nftRegistry = IERC721(nftContract);
        require(
